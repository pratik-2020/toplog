      ...
      <Container sx={styles.banner.container}>
        <Box sx={styles.banner.contentBox}>
          <Heading as="h1" variant="heroPrimary">
            A Creative and Innovative way to grow your Exciting Business model
          </Heading>
          <Text as="p" variant="heroSecondary">
            Get an innovative and technical solution for solving your buisness issues and help you grow with technology.
          </Text>
          {/* <Subscribe /> */}
